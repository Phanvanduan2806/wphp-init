...
if (!class_exists('RelatedBlog')) {
    class RelatedBlog
    {
        ...
        {
            add_shortcode('related_blog', array(__CLASS__, 'related_blog'));
        ...
        public static function related_blog()
        {
            ...
            if ($cat_ids):
                $args = array(
                    ...
                    'posts_per_page' => get_theme_mod('at_max_related_blog', 6),
                    'orderby' => 'rand'
                );
            ...
            if ($ids) {
                ...
                <div id='at_posts_related'>
                    [gap height="20px"]
                    <b class='container-width posts-section-title-related pt-half pb-half uppercase h3'> <?php echo esc_html($title_text) ?> </b>
                    [gap height="10px"]
                    <?php
